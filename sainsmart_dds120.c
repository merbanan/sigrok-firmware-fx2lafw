...
/** Each lsb bit in the nibble of the byte controls
 * the coupling per channel
 *
 * Setting PE3 disbles AC coupling capacitor on CH0
 * Setting PE0 disbles AC coupling capacitor on CH1
 */
